...
export default function AboutPage() {
  ...
  return (
    <div className="min-h-screen bg-slate-50 flex flex-col font-sans antialiased text-slate-800">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            ...
            <div className="lg:col-span-7 grid grid-cols-1 sm:grid-cols-2 gap-6 order-2 lg:order-1">
              {competencies.cards.map((card, idx) => (
                <div 
                  key={idx} 
                  className={`p-6 rounded-xl border text-left flex flex-col space-y-3 shadow-sm hover:shadow-md transition-all duration-300 ${
                    card.isDark 
                ...
                >
                  <div className={`w-9 h-9 rounded-lg flex items-center justify-center shrink-0 ${
                    card.isDark ? "bg-white/10 text-accent-muted" : "bg-blue-50/80 text-accent"
                  }`}>
                  ...
                  <p className={`text-xs sm:text-sm leading-relaxed ${
                    card.isDark ? "text-slate-300" : "text-slate-500"
                  }`}>
                    {card.description}
                  </p>
                </div>
              ...
              {journey.timeline.map((step, idx) => {
                ...
                return (
                  ...
                  >
                    ...
                    <div className={`w-full md:w-1/2 flex items-center justify-start pl-14 md:pl-0 ${
                      isEven 
                        ? "md:pl-16" 
      ...
      {/* 7. Bottom CTA Block */}
      <section className="bg-primary text-white py-16 text-center border-t border-slate-900 overflow-hidden relative">
        ...
        <div className="max-w-4xl mx-auto px-4 relative z-10 space-y-6">
          ...
          <div className="flex flex-col sm:flex-row justify-center items-center gap-4 pt-4">
            ...
            <Button 
              variant="outline-white" 
              onClick={() => alert("Brochure download triggered successfully.")}
              className="w-full sm:w-auto px-8 py-3 rounded-lg font-bold border-white text-white hover:bg-white/10 transition-all"
            >
              Download Brochure
            </Button>
          </div>
